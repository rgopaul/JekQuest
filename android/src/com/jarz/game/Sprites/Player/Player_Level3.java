...
* */
public class Player_Level3 extends Sprite
{
    public World world;
    public Body b2body;
    ...
    private Level3 screen;


    //Main Constructor
    public Player_Level3(World world, Level3 screen)
    {
    ...
    public void update(float dt)
    {
        ...
        // Die when falling into a pit (Below the Map)
    ...
    * */
    public void definePlayer()
    {
        ...
        bdef.position.set(1550 / Platformer.PPM , 32/Platformer.PPM); //Set Stage Position
        //bdef.position.set(5550 / Platformer.PPM , 32/Platformer.PPM); //Set Stage Position (At End of Stage)
        ...
        shape.setRadius(6 / Platformer.PPM); //Note this Hitbox is Slightly Bigger than Our Level 1 Hitbox
        ...
        fdef.filter.maskBits = Platformer.GROUND_BIT |
                ...
                Platformer.OBSTACLE_BIT |
                Platformer.PLATFORM_BIT |
                Platformer.PORTAL_BIT;
